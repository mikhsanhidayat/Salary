...
const Page = () => {
 ...
 useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-blacktable">
                  ...
                  <form className="space-y-5 " onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-3 pt-2">
                      <button
                        ...
                        className="flex-1 rounded-xl bg-[#004d73] px-4 py-3 text-sm font-bold text-white shadow-lg shadow-[#004d73]/20 transition-all hover:bg-[#003a57] hover:shadow-[#004d73]/30 active:scale-[0.98]"
                      >
    ...
    <tr className="group hover:bg-slate-50/50 dark:hover:bg-zinc-800/30 transition-colors">
      ...
      <td className="px-8 py-5 text-right">
        <div className="flex justify-end gap-3 translate-x-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
          ...
          <button
            className="h-9 w-9 flex items-center justify-center text-slate-400 hover:text-white hover:bg-rose-500 rounded-xl transition-all shadow-sm"
            title="Hapus"
          >
            🗑️
          </button>
